...
Audio3DManager::
Audio3DManager( PT( AudioManager ) audio_mgr, const NodePath &listener_target,
...
stop_update()
{
        if ( _update_task != ( GenericAsyncTask * )NULL )
        {
 ...
 */
PT( AudioSound ) Audio3DManager::
load_sfx( const Filename &name )
{
 ...
 */
void Audio3DManager::
set_distance_factor( PN_stdfloat factor )
{
        _audio_manager->audio_3d_set_distance_factor( factor );
}

PN_stdfloat Audio3DManager::
get_distance_factor() const
{
 ...
 */
void Audio3DManager::
set_doppler_factor( PN_stdfloat factor )
{
        _audio_manager->audio_3d_set_doppler_factor( factor );
}

PN_stdfloat Audio3DManager::
get_doppler_factor() const
{
 ...
 */
void Audio3DManager::
set_drop_off_factor( PN_stdfloat factor )
{
        _audio_manager->audio_3d_set_drop_off_factor( factor );
}

PN_stdfloat Audio3DManager::
get_drop_off_factor() const
{
 ...
 */
void Audio3DManager::
set_sound_min_distance( PT( AudioSound ) sound, PN_stdfloat dist )
{
        sound->set_3d_min_distance( dist );
}

PN_stdfloat Audio3DManager::
get_sound_min_distance( PT( AudioSound ) sound ) const
{
 ...
 */
void Audio3DManager::
set_sound_max_distance( PT( AudioSound ) sound, PN_stdfloat dist )
{
        sound->set_3d_max_distance( dist );
}

PN_stdfloat Audio3DManager::
get_sound_max_distance( PT( AudioSound ) sound ) const
{
 ...
 */
void Audio3DManager::
set_sound_velocity( PT( AudioSound ) sound, const LVector3f &velocity )
{
        _velocities[sound] = VelocityData( velocity, false );
}

LVector3f Audio3DManager::
get_sound_velocity( PT( AudioSound ) sound )
{
 ...
 */
void Audio3DManager::
set_sound_velocity_auto( PT( AudioSound ) sound )
{
 ...
 */
void Audio3DManager::
set_listener_velocity( const LVector3f &vel )
{
...
void Audio3DManager::
remove_existing_sound( AudioSound *sound )
{
...
void Audio3DManager::
attach_sound_to_object( PT( AudioSound ) sound, const NodePath &object )
{
        remove_existing_sound( sound );
...
void Audio3DManager::
detach_sound( PT( AudioSound ) sound )
{
        remove_existing_sound( sound );
}

Audio3DManager::SoundVec Audio3DManager::
get_sounds_on_object( const NodePath &object )
{
        SoundVec result;
...
void Audio3DManager::
attach_listener( const NodePath &listener )
{
 ...
 * in a task.
 */
AsyncTask::DoneStatus Audio3DManager::
update_task( GenericAsyncTask *task, void *data )
{
        ...
        if ( a3dm->_audio_manager == ( AudioManager * )NULL ||
