...
PPGuiScrollFrame::PPGuiScrollFrame( const string &name ) :
        PGScrollFrame( name )
{
}

NodePath &PPGuiScrollFrame::get_canvas()
{
        return _canvas_np;
}

void PPGuiScrollFrame::setup( PN_stdfloat width, PN_stdfloat height,
