...
extern EXPORT_CLIENT_DLL float g_flLastPacketTimestamp;
...
class EXPORT_CLIENT_DLL CInterpolationContext
{
public:
...
extern EXPORT_CLIENT_DLL ConfigVariableDouble cl_extrapolate_amount;
...
class EXPORT_CLIENT_DLL IInterpolatedVar
{
public:
	...
	Type *pOut, float currentTime )
{
	...
	if ( bExtrapolate )
	{
		...
		diff = std::clamp( diff, 0.0f, cl_extrapolate_amount * 2 );
