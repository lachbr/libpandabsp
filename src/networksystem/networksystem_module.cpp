...
extern const struct LibraryDef networksystem_moddef;
extern void Dtool_networksystem_RegisterTypes();
extern void Dtool_networksystem_BuildInstants(PyObject *module);

#if PY_MAJOR_VERSION >= 3
extern "C" EXPORT_CLASS PyObject *PyInit_networksystem();
#else
extern "C" EXPORT_CLASS void initnetworksystem();
#endif
...
PyObject *PyInit_networksystem() {
  PyImport_Import(PyUnicode_FromString("panda3d.core"));
  Dtool_networksystem_RegisterTypes();

  const LibraryDef *defs[] = {&networksystem_moddef, nullptr};

  PyObject *module = Dtool_PyModuleInitHelper(defs, &py_networksystem_module);
  if (module != nullptr) {
