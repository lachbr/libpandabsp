#ifndef __CONFIG_PPDISTRIBUTED_H__
#define __CONFIG_PPDISTRIBUTED_H__
...
#ifdef BUILDING_PPDISTRIBUTED
#define EXPCL_PPDISTRIBUTED __declspec(dllexport)
#define EXPTP_PPDISTRIBUTED __declspec(dllexport)
#else
#define EXPCL_PPDISTRIBUTED __declspec(dllimport)
#define EXPTP_PPDISTRIBUTED __declspec(dllimport)
#endif

NotifyCategoryDeclNoExport( config_ppDistributed );

extern ConfigVariableDouble timemanager_update_freq;
extern ConfigVariableDouble timemanager_min_wait;
extern ConfigVariableDouble timemanager_max_uncertainty;
extern ConfigVariableInt timemanager_max_attemps;
extern ConfigVariableInt timemanager_extra_skew;
extern ConfigVariableDouble timemanager_report_fr_ival;
...
enum MsgType
{
        ...
        CLIENTAGENT_CLEAR_POST_REMOVE = 1111,
        ...
        CLIENT_OBJECT_UPDATE_FIELD_TARGETED_CMU = 9012
};

extern EXPCL_PPDISTRIBUTED void init_libppdistributed();

#endif // __CONFIG_PPDISTRIBUTED_H__