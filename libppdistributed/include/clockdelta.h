...
class EXPCL_PPDISTRIBUTED ClockDelta
{
public:
        ClockDelta();
        ...
        void resynchronize( double localtime, double nettime, double newuncertaincy, bool trustnew = true );
        ...
        static ClockDelta *get_global_ptr();
