...
void DistributedNodeAI::delete_do()
{
        if ( !is_empty() )
        {
                remove_node();
...
void DistributedNodeAI::b_set_parent( int parent_token )
{
        set_parent( parent_token );
        d_set_parent( parent_token );
}

void DistributedNodeAI::d_set_parent( int parent_token )
{
...
void DistributedNodeAI::set_parent( int parent_token )
{
        do_set_parent( parent_token );
}

void DistributedNodeAI::do_set_parent( int parent_token )
{
        // not implemented.
}

void DistributedNodeAI::set_parent_field( DCFuncArgs )
{
...
void DistributedNodeAI::set_x_field( DCFuncArgs )
{
        ( (DistributedNodeAI *)data )->set_x( packer.unpack_double() );
}

void DistributedNodeAI::get_x_field( DCFuncArgs )
{
...
void DistributedNodeAI::set_y_field( DCFuncArgs )
{
        ( (DistributedNodeAI *)data )->set_y( packer.unpack_double() );
}

void DistributedNodeAI::get_y_field( DCFuncArgs )
{
...
void DistributedNodeAI::set_z_field( DCFuncArgs )
{
        ( (DistributedNodeAI *)data )->set_z( packer.unpack_double() );
}

void DistributedNodeAI::get_z_field( DCFuncArgs )
{
...
void DistributedNodeAI::set_h_field( DCFuncArgs )
{
        ( (DistributedNodeAI *)data )->set_h( packer.unpack_double() );
}

void DistributedNodeAI::get_h_field( DCFuncArgs )
{
...
void DistributedNodeAI::set_p_field( DCFuncArgs )
{
        ( (DistributedNodeAI *)data )->set_p( packer.unpack_double() );
}

void DistributedNodeAI::get_p_field( DCFuncArgs )
{
...
void DistributedNodeAI::set_r_field( DCFuncArgs )
{
        ( (DistributedNodeAI *)data )->set_r( packer.unpack_double() );
}

void DistributedNodeAI::get_r_field( DCFuncArgs )
{
